	...
	<main>
		...
		<header>
			<div class="header-left">
				<img src="FIRST_Horz_RGB.png" class="logo"/>
			</div>
			...
			<div class="header-right">
				<h2>User: Guest</h2> <!-- FILL IN VARIABLE FOR USER LATER -->
		...
		<table id="displayTable">
			...
			<tbody>
				<tr>
					<td><img class="checkImg" src="icons8-checkmark-filled-100-black.png" /></td>
					<td></td>
					<td>Smith</td>
					<td></td>
					<td><img class="checkImg" src="icons8-checkmark-filled-100-black.png" /></td>
